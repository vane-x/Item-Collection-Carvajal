          ...
          >
            <Demo>
              ...
              <List>
                              ...
                              secondary={
                                <>
                                  ...
                                  <Typography
                                    variant="button"
                                    display="flex"
                                    sx={{ justifyContent: "flex-start", pr: 6, marginTop: "0.1rem" }}
                                    gutterBottom
                                  >
                                    <><strong>Precio por cantidad: $ ${item.pricexqtty}</strong></>
                                  </Typography>
                                </>
                              }
                            />
                ...
                <Typography variant="button" display="flex" sx={{ justifyContent: "flex-end", pr: 6, pt: 2 }} gutterBottom>
                  <> Total de Unidades: {totalUnits}</>
                </Typography>
                <Typography variant="button" display="flex" sx={{ justifyContent: "flex-end", pr: 6 }}  gutterBottom>
